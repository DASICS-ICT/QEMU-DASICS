                                    ...
                                    target_ulong val)
{
    ...
    mask = MSTATUS_SIE | MSTATUS_SPIE | MSTATUS_MIE | MSTATUS_MPIE |
        ...
        MSTATUS_TW | MSTATUS_VS | MSTATUS_UIE | MSTATUS_UPIE;
...
static RISCVException write_djcfg(CPURISCVState *env, int csrno, target_ulong val)
{
...
static RISCVException write_djbound(CPURISCVState *env, int csrno, target_ulong val)
{
    int idx = csrno - CSR_DJBOUND0;
